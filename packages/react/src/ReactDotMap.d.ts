...
} & Pick<React.ComponentProps<'div'>, 'style' | 'className'> & Partial<DotMapOptionArg>;
export declare function ReactDotMap({ anchors, lines, components, style, className, backgroundColor, gapSize, pixelColor, pixelSize, dotType, renderer, }: Props): JSX.Element;
